                    ...
                    <div className='flex justify-between p-[3rem_15px]'>
                        <div className='flex flex-col gap-[2rem]'>
                            ...
                            <div id="footer">
                                <ul className='flex items-center gap-[13px]'>
                                    <li className={`border-white flex items-center justify-center p-2 border cursor-pointer rounded-full w-[26px] h-[26px]`}>
                                        <FaFacebookF size={18} />
                                    </li>
                                    <li className={`border-white flex items-center justify-center p-[0.35rem] cursor-pointer border rounded-full w-[26px] h-[26px]`}>
                                        <FaTwitter size={18} />
                                    </li>
                                    <li className={`border-white flex items-center justify-center p-[0.35rem] cursor-pointer border rounded-full w-[26px] h-[26px]`}>
                        ...
                        <div>
                            ...
                            <ul className='flex flex-col gap-[10px]'>
                                <li className={`text-gray-400 text-[14px] hover:text-[#E51636] cursor-pointer`}>About Company</li>
                                <li className={`text-gray-400 text-[14px] hover:text-[#E51636] cursor-pointer`}>Careers</li>
                                <li className={`text-gray-400 text-[14px] hover:text-[#E51636] cursor-pointer`}>Contact Us</li>
                                <li className={`text-gray-400 text-[14px] hover:text-[#E51636] cursor-pointer`}>FAQs</li>
                            </ul>
                        </div>
                        <div>
                            <h6 className='font-bold text-[14px] mb-[25px]'>Media Relations</h6>
                            <ul className='flex flex-col gap-[10px]'>
                                <li className={`text-gray-400 text-[14px] hover:text-[#E51636] cursor-pointer`}>Media Kit</li>
                            </ul>
                        </div>
                        <div>
                            <h6 className='font-bold text-[14px] mb-[25px]'>Vehicle Categories</h6>
                            <ul className='flex flex-col gap-[10px]'>
                                <li className={`text-gray-400 text-[14px] hover:text-[#E51636] cursor-pointer`}>SUV</li>
                            </ul>
                        </div>
                        <div>
                            <h6 className='font-bold text-[14px] mb-[25px]'>Trending Pages</h6>
                            <ul className='flex flex-col gap-[10px]'>
                                <li className={`text-gray-400 text-[14px] hover:text-[#E51636] cursor-pointer`}>Book a Test Drive</li>
                                <li className={`text-gray-400 text-[14px] hover:text-[#E51636] cursor-pointer`}>Locate a Dealer</li>
                            </ul>
                        </div>
                    </div>
                </div>
